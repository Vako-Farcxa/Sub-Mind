...
-- CreateIndex
CREATE UNIQUE INDEX "DetectedSubscription_userId_rawEmailId_key" ON "DetectedSubscription"("userId", "rawEmailId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Notification_userId_subscriptionId_channel_scheduledFor_key" ON "Notification"("userId", "subscriptionId", "channel", "scheduledFor");
